...
function liveDesktopWeb(blob, region, user, jobId) {
    ...
    if (blob.log_url !== null) {
        let assets = {
            video: `https://${region}.com/rest/v1/${user}/jobs/${jobId}/assets/video.mp4`,
            selenium_log: `https://${region}.com/rest/v1/${user}/jobs/${jobId}/assets/selenium-server.log`,
            sauce_log: `https://${region}.com/rest/v1/${user}/jobs/${jobId}/assets/log.json`
        }
        info = { ...info, assets }
    }
    return JSON.stringify(info, null, 4)
...
export { rdcInfo, nonAppInfo, liveDesktopWeb };